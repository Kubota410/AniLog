...
import {
  AnimeListScreenTemplate,
  LoginScreenTemplate,
  SettingButtonScreenTemplate,
  SettingNotifyScreenTemplate,
...
const CustomDrawerContent = (props: any) => (
  ...
  <DrawerContentScrollView {...props}>
    ...
    <DrawerItem
      label="ボタン設定"
      onPress={() => props.navigation.navigate("ButtonSetting")}
    />
    <DrawerItem
      label="通知設定"
      onPress={() => props.navigation.navigate("NotifySetting")}
    />
    <DrawerItem
      label="アプデ日記"
      onPress={() => props.navigation.navigate("UpdateDiary")}
    />
